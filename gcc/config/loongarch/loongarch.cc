	  ...
	  if (length - offset >= 16)
	    {
	      ...
	      loongarch_emit_move (regs_tmp[0],
				   adjust_address (src, V2DImode, offset));
	      loongarch_emit_move (adjust_address (dest, V2DImode, offset),
				   regs_tmp[0]);
	      offset += 16;
	    }
	  if (length - offset  >= 8)
	    {
	      ...
	      loongarch_emit_move (regs_tmp[0],
				   adjust_address (src, DImode, offset));
	      loongarch_emit_move (adjust_address (dest, DImode, offset),
				   regs_tmp[0]);
	      offset += 8;
	    }
	  if (length - offset >= 4)
	    {
	      ...
	      loongarch_emit_move (adjust_address (dest, SImode, offset),
				   regs_tmp[0]);
	      offset += 4;
	    }
	  if (length - offset >= 2)
	    {
	      ...
	      loongarch_emit_move (adjust_address (dest, HImode, offset),
				   regs_tmp[0]);
	      offset += 2;
	    }
	  if (length - offset >= 1)
	    {
	      ...
	      loongarch_emit_move (adjust_address (dest, QImode, offset),
				   regs_tmp[0]);
	      offset += 1;
	    }
